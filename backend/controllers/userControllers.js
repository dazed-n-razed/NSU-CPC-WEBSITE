...
const registerUser = asyncHandler(async (req, res) => {
  ...
  console.log("Registration request received:", { name, email, status, nsuID });

  const picture = inputs?.image || "https://icon-library.com/images/anonymous-avatar-icon/anonymous-avatar-icon-25.jpg";
  ...
  console.log("User created successfully:", { _id: user._id, email, userType });
